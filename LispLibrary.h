...
"(defun update-d1 () (useqDigitalWrite 1 (eval d1-form)))  \n"
"(defun update-d2 () (useqDigitalWrite 2 (eval d2-form)))  \n"
"(defun update-d3 () (useqDigitalWrite 3 (eval d3-form)))  \n"
"(defun update-d4 () (useqDigitalWrite 4 (eval d4-form)))  \n"
